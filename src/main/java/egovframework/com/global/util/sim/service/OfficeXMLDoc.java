/**
 * Class Name : OfficeXMLDoc.java Description : XML파일을 파싱하여 구조체 형태로 반환 또는 구조체 형태의 데이터를 XML파일로 저장하는
...
public class OfficeXMLDoc {
    ...
    // Log
    // protected static final Log log = LogFactory.getLog(OfficeXMLDoc.class);
    /**
    ...
    public static boolean creatSchemaToClass(String xml, String ja) throws Exception {
        ...
        String cmdStr = GlobalsProperties.getPathProperty(Globals.SHELL_FILE_PATH,
                "SHELL." + Globals.OS_TYPE + ".compileSchema");
        String[] command =
                {cmdStr.replace('\\', FILE_SEPARATOR).replace('/', FILE_SEPARATOR), jar, file};
     ...
     * @exception Exception
     */
    public static boolean getClassToXML(String file) throws Exception {
        ...
        try {
            ...
            file1 = OfficeFileTool.createNewFile(file1);
