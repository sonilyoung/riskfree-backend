/**
 * Class Name : OfficePdfCnvr.java Description : xls,doc,ppt를 Pdf로 변환하는 화면 Business Interface class
...
public class OfficePdfCnvr {
     ...
     * @see
     */
    public static boolean getPDF(String targetPdf, HttpServletRequest request,
        ...
        try {
            ...
            while (file_iter.hasNext()) {
                ...
                if (mFile.getSize() > 0) {
                    ...
                    String stordFilePath =
                            GlobalsProperties.getProperty("Globals.uploadFileStorePath");
                    ...
                    newName = OfficeStringUtil.getTimeStamp();
                    writeFile(mFile, newName, stordFilePath);

                    String pdfFileSrcValue = stordFilePath.replace('\\', FILE_SEPARATOR)
                    ...
                    if (inputFile.exists()) {
                        ...
                        valueFile = inputFile.getParent().replace('\\', FILE_SEPARATOR).replace('/',
                                FILE_SEPARATOR);
            ...
            BasicLogger.debug("PDF converting error", ex);
    ...
    protected static void writeFile(MultipartFile file, String newName, String stordFilePath)
        ...
        try {
            ...
            bos = new FileOutputStream(
                    WebUtil.filePathBlackList(stordFilePath + File.separator + newName));
