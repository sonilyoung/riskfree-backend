/**
 * Class Name : OfficeFileTool.java Description : 시스템 디렉토리 정보를 확인하여 제공하는 Business class Modification
 * Information
 *
 ...
 */
package egovframework.com.global.util.sim.service;
...
public class OfficeFileTool {
    ...
    // Log
    // protected static final Log log = LogFactory.getLog(OfficeFileTool.class);
    private static final Logger LOGGER = LoggerFactory.getLogger(OfficeFileTool.class);
    ...
    public static List<String> getExistDirectory(String baseDirPath, String targetDirPath, int cnt)
        ...
        if (baseDirPath == null || baseDirPath.equals("") || targetDirPath == null
                || targetDirPath.equals("") || cnt == 0) {
        ...
        for (int i = 0; dirList != null && i < dirList.length; i++) {
            ...
            if (targetDirPath.equals(dirList[i])) {
                ...
                if (new File(WebUtil.filePathBlackList(baseDirPath) + "/" + dirList[i])
                        .isDirectory()) {
                    dirFindCnt++;
    ...
    public static boolean getExistDirectory(String targetDirPath, String fromDate, String toDate)
        ...
        // 인자값 유효하지 않은 경우 공백 리턴
        if (targetDirPath == null || targetDirPath.equals("") || fromDate == null
    ...
    public static boolean getExistDirectory(String targetDirPath, String ownerName)
        ...
        // 인자값 유효하지 않은 경우 공백 리턴
        if (targetDirPath == null || targetDirPath.equals("") || ownerName == null
                || ownerName.equals("")) {
            return false;
        }
     ...
     */
    public static List<String> getLastDirectoryForModifiedDate(String baseDirPath, String fromDate,
            String toDate) {

        // 인자값 유효하지 않은 경우 빈 ArrayList 리턴
        if (baseDirPath == null || baseDirPath.equals("") || fromDate == null || fromDate.equals("")
        ...
        for (int i = 0; i < subDirList.length; i++) {
            ...
            if (childFile.isDirectory()) {
                ...
                childResult = getLastDirectoryForModifiedDate(baseDirPath + "/" + subDirList[i],
                        fromDate, toDate);
                // 하위디렉토리의 결과를 추가한다.
        ...
        for (int i = 0; i < fileArray.length; i++) {
            ...
            if (fileArray[i].isDirectory()) {
                ...
                if (Globals.OS_TYPE.equals("UNIX")) {
                    String[] command = {
                            GlobalsProperties.getProperty(Globals.SHELL_FILE_PATH,
                    ...
                    String command = GlobalsProperties.getProperty(Globals.SHELL_FILE_PATH,
                            "SHELL." + Globals.OS_TYPE + ".getDrctryByOwner");
                    p = Runtime.getRuntime().exec(command);
                    p.waitFor();
                }
                ...
                if (p != null && p.exitValue() != 0) {
                    ...
                    try {
                        ...
                        ResourceCloseHelper.close(b_err);
                    }
                }
                // 프로세스 실행 성공시 결과 확인
                else {
                    ...
                    try {
                        ...
                        while (b_out.ready()) {
                            ...
                            if (tmpStr != null && "".equals(tmpStr)
                                    && tmpStr.length() <= MAX_STR_LEN) {
                                list.add(fileArray[i].getAbsolutePath());
                            }
                        }
                    } finally {
                        ResourceCloseHelper.close(b_out);
                    }
                }
            }
        }
    ...
    public static Vector<List<String>> parsFileByChar(String parFile, String parChar, int parField)
        ...
        try {
            ...
            if (file.exists() && file.isFile()) {
                ...
                String[] strArr = OfficeStringUtil.split(strBuff.toString(), parChar);
    ...
    public static boolean cmprFilesByUpdtPd(String cmprFile1, String cmprFile2) throws Exception {
        ...
        if (file1.exists() && file2.exists() && file1.isFile() && file2.isFile()) {
            ...
            java.text.SimpleDateFormat dateFormat1 =
                    new java.text.SimpleDateFormat("yyyyMMdd", java.util.Locale.KOREA);
    ...
    public static boolean cmprFilesByContent(String cmprFile1, String cmprFile2) throws Exception {
        ...
        try {
            ...
            ResourceCloseHelper.close(br1, br2);
        }
    ...
    public static boolean cmprFilesByOwner(String cmprFile1, String cmprFile2) throws Exception {
        ...
        if (owner1 != null && owner2 != null && !"".equals(owner1) && !"".equals(owner2)
     ...
     * @exception Exception
     */
    public static boolean copyFilesByUpdtPd(String source, String updtFrom, String updtTo,
    ...
    public static boolean execCopyFile(File srcFile, File tarFile) throws Exception {
        ...
        try {
            ...
            if (tarFile1.isDirectory()) {
                tarFile1 = new File(WebUtil.filePathBlackList(tarFile1.getAbsolutePath()) + "/"
                        + srcFile.getName());
            }
            ...
            ResourceCloseHelper.close(fis, fos);
        }
    ...
    public static String deleteDirectory(String dirDeletePath, String dirOwner) {
        ...
        // 인자값 유효하지 않은 경우 블랭크 리턴
        if (dirDeletePath == null || dirDeletePath.equals("") || dirOwner == null
                || dirOwner.equals("")) {
            return "";
        }
    ...
    public static String deleteDirectory(String dirDeletePath, String fromDate, String toDate) {
        ...
        // 인자값 유효하지 않은 경우 블랭크 리턴
        if (dirDeletePath == null || dirDeletePath.equals("") || fromDate == null
                || fromDate.equals("") || toDate == null || toDate.equals("")) {
            return "";
        }
    ...
    public static String getMountLc(String file) throws Exception {
        ...
        if (srcFile.exists()) {
            ...
            if (Globals.OS_TYPE.equals("UNIX")) {
                Process p = null;
                String[] command = {GlobalsProperties.getProperty(Globals.SHELL_FILE_PATH,
                        "SHELL." + Globals.OS_TYPE + ".getMountLc"), src, "/"};
                p = Runtime.getRuntime().exec(command);
                // p.waitFor();

                // boolean result = false;
                BufferedReader b_out =
    ...
    public static String getOwner(String file) throws Exception {
        ...
        try {
            ...
            if (srcFile.exists()) {
                ...
                Process p = null;
                String cmdStr = GlobalsProperties.getProperty(Globals.SHELL_FILE_PATH,
                        "SHELL." + Globals.OS_TYPE + ".getDrctryOwner");
                String[] command = {
                        cmdStr.replace('\\', FILE_SEPARATOR).replace('/', FILE_SEPARATOR),
            ...
            ResourceCloseHelper.close(b_err, b_out);
        }
        ...
        try {
            ...
            if (srcFile.exists()) {
                ...
                if (Globals.OS_TYPE.equals("UNIX")) {
                    String[] command = {
                            GlobalsProperties.getProperty(Globals.SHELL_FILE_PATH,
                                    "SHELL." + Globals.OS_TYPE + ".getDrctryAccess"),
                            parentPath, fname};
                    p = Runtime.getRuntime().exec(command);
                    p.waitFor();
                    // 프로세스 에러시 종료
    ...
    public static String getFormat(String file) throws Exception {
        ...
        if (srcFile.exists()) {
            ...
            if (strArr.length >= 2) {
                ...
                type = GlobalsProperties.getProperty(Globals.FILE_FORMAT_PATH, format);
            }
        }
            ...
            if (targetDirPath1.equals("")) {
                ...
                if (originalFileList.length > 0) {
                    for (int i = 0; i < originalFileList.length; i++) {
                        File subF = new File(WebUtil.filePathBlackList(originalDirPath)
                                + FILE_SEPARATOR + originalFileList[i]);
                        if (subF.isFile()) {
                            // 하위목록이 파일이면 파일복사실행 -> 실패 발생하는 경우 복사를 중단한다.
                            result = copyFile(
                                    originalDirPath + FILE_SEPARATOR + originalFileList[i],
                                    targetDir.getAbsolutePath() + FILE_SEPARATOR
                                            + originalFileList[i]);
                        } else {
    ...
    public static boolean copyDirectory(String originalDirPath, String targetDirPath,
        ...
        // 인자값 유효하지 않은 경우 공백 리턴
        if (originalDirPath == null || originalDirPath.equals("") || targetDirPath == null
                || targetDirPath.equals("") || fromDate == null || fromDate.equals("")
                || toDate == null || toDate.equals("")) {
            return false;
        }
        boolean result = false;
                ...
                if (originalFileList.length > 0) {
                    for (int i = 0; i < originalFileList.length; i++) {
                        ...
                        if (subF.isFile()) {
                            ...
                            // 하위목록이 디렉토리이면 복사를 재귀적으로 호출한다.
                            // 하위목록에 해당하는 폴더에 대해서는 생성일자 검사를 하지 않는다.(현재 폴더가 복사대상이면 현재폴더의 하위는 제외없이
                            // 복사함)
                            result = copyDirectory(originalDirPath + "/" + originalFileList[i],
                                    targetDirPath1 + "/" + originalFileList[i]);
                        }
    ...
    public static boolean copyDirectory(String originalDirPath, String targetDirPath, String owner)
        ...
        // 인자값 유효하지 않은 경우 공백 리턴
        if (originalDirPath == null || originalDirPath.equals("") || targetDirPath == null
                || targetDirPath.equals("") || owner == null || owner.equals("")) {
            return false;
        }
        boolean result = false;
        File f = null;
        ...
        try {
            ...
            if (f.exists()) {
                ...
                if (targetDir.exists()) {
                    ...
                    String[] command = {
                            cmdStr.replace('\\', FILE_SEPARATOR).replace('/', FILE_SEPARATOR),
                            WebUtil.filePathBlackList(originalDirPath.replace('\\', FILE_SEPARATOR)
                                    .replace('/', FILE_SEPARATOR)),
                            WebUtil.filePathBlackList(targetDirPath.replace('\\', FILE_SEPARATOR)
                                    .replace('/', FILE_SEPARATOR))};
     ...
     * @return boolean result 이동이 성공하면 true, 실패하면 false를 리턴한다.
     */
    public static boolean moveFile(String originalDirPath, String targetDirPath, String fromDate,
            ...
            if (f.exists()) {
                ...
                if (targetDir.exists()) {
                    ...
                    if (isInCondition) {
                        ...
                        String[] command =
                                {cmdStr.replace('\\', FILE_SEPARATOR).replace('/', FILE_SEPARATOR),
                                        WebUtil.filePathBlackList(
                                                originalDirPath.replace('\\', FILE_SEPARATOR)
                                                        .replace('/', FILE_SEPARATOR)),
                                        WebUtil.filePathBlackList(
                                                targetDirPath.replace('\\', FILE_SEPARATOR)
                                                        .replace('/', FILE_SEPARATOR))};
                        Process p = Runtime.getRuntime().exec(command);
                        String access = "";
                        p.waitFor();
    ...
    public static boolean startDirectoryMonitering(String targetDirPath) throws Exception {
        ...
        try {
            ...
            File logF = new File(WebUtil.filePathBlackList(Globals.CONF_PATH) + "/"
                    + targetF.getName() + ".log");
            ...
            if (targetF.exists() && targetF.isDirectory()) {
                ...
                if (logF.exists()) {
                    ...
                    if (lastStr.equals("END")) {
                        OfficeFileMntrg t =
                                new OfficeFileMntrg(WebUtil.filePathBlackList(targetDirPath), logF);
                        t.start();
                    }
                } else {
                    result = logF.createNewFile();
                    OfficeFileMntrg t = new OfficeFileMntrg(targetDirPath, logF);
                    t.start();
                }
            }
        } finally {
            ResourceCloseHelper.close(fr, br);
        }
    ...
    public static boolean stopDirectoryMonitering(String targetDirPath) throws Exception {
        ...
        try {
            ...
            ResourceCloseHelper.close(fr, br, fWriter, bWriter);
        }
