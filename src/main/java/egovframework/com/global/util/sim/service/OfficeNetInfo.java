/**
 * Class Name : ComUtlSimNetInfo.java Description : 시스템 네트워크 정보를 확인하여 제공하는 Business class
...
public class OfficeNetInfo {
    ...
    public static String getHostName() throws Exception {
        ...
        String command = GlobalsProperties.getPathProperty(Globals.SHELL_FILE_PATH,
