...
public class DefaultFileSaveManager implements FileSaveManager {
	...
	@Override
	public String saveFile(FileItem fileItem, String imageBaseDir, String imageDomain, String appDir) {
		String originalFileName = FilenameUtils.getName(fileItem.getName());
		String relUrl;
		// filename
		String subDir = appDir + DirectoryPathManager.getDirectoryPathByDateType(DirectoryPathManager.DIR_DATE_TYPE.DATE_POLICY_YYYY_MM_DD);
