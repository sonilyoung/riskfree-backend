...
public class OfficeFormBasedUUID implements Serializable {
    /*
     ...
     */
    private OfficeFormBasedUUID(byte[] data) {
        long msb = 0;
        long lsb = 0;
        for (int i = 0; i < 8; i++)
     ...
     * @param leastSigBits
     */
    public OfficeFormBasedUUID(long mostSigBits, long leastSigBits) {
     ...
     */
    public static OfficeFormBasedUUID randomUUID() {
        ...
        return new OfficeFormBasedUUID(randomBytes);
    }
     ...
     */
    public static OfficeFormBasedUUID nameUUIDFromBytes(byte[] name) {
        MessageDigest md;
        try {
        ...
        return new OfficeFormBasedUUID(md5Bytes);
    }
     ...
     */
    public static OfficeFormBasedUUID fromString(String name) {
        ...
        return new OfficeFormBasedUUID(mostSigBits, leastSigBits);
    }
	...
	public boolean equals(Object obj) {
    	...
    	if (!(obj instanceof OfficeFormBasedUUID))
            return false;
        if (((OfficeFormBasedUUID) obj).variant() != this.variant())
            return false;
        OfficeFormBasedUUID id = (OfficeFormBasedUUID) obj;
     ...
     */
    public int compareTo(OfficeFormBasedUUID val) {
