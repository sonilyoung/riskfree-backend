...
public class OfficeStringUtil {
	...
	/**
	 * 공통 롤에 맞춘 테이블 ID값을 구한다
	 *
	 * @param id  id
	 * @param prefix id와 조합할 문자열
	 * @param totalLength 반환할 문자열 길이
	 * @return 조합한 ID
	 */
	public static String composeTableId(String id, String prefix, int totalLength){
		StringBuilder newId = new StringBuilder();
		newId.append(prefix);

		int zeroLength = totalLength - (id.length() + prefix.length());
