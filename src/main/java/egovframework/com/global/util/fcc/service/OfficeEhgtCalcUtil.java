...
public class OfficeEhgtCalcUtil {
	...
	public void readHtmlParsing(String str) {
		...
		try {
			...
			ResourceCloseHelper.close(reader, is);
	...
	private class CallbackHandler extends HTMLEditorKit.ParserCallback {
		...
		public void handleText(char[] data, int pos) {
			...
			srcStr = OfficeStringUtil.strip(srcStr, " ");
	...
	public static String getEhgtCalc(String srcType, long srcAmount, String cnvrType) throws Exception {
		...
		OfficeEhgtCalcUtil parser = new OfficeEhgtCalcUtil();
		...
		eghtStdrRt = OfficeStringUtil.split(sb.toString(), "/");
